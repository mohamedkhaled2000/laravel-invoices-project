				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='parital') }}">الفواتير المدفوعة جزئيا</a></li>
                                @endcan

                                @can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='Archives') }}"> الفواتير المؤرشفه</a></li>
                                @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('تقرير الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invoces_report') }}">تقارير الفواتير</a></li>
                            @endcan

                            @can('تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='client_report') }}">تقارير العملاء</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @can('المنتجات')
							<li><a class="slide-item" href="{{ url('/' . $page='prodacts') }}">المنتجات</a></li>
                                @endcan
						</ul>
					</li>
                    @endcan
