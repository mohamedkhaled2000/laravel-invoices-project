...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">معاينه الفاتورة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ معاينة طباعه الفاتورة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
								...
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>تاريخ الفاتورة:</span> <span>{{ $invoices->invoice_data }}</span></p>
											<p class="invoice-info-row"><span>تاريخ الاستحقاق:</span> <span>{{ $invoices->due_data }}</span></p>
										</div>
									</div>
									...
									<hr class="mg-b-40">
									<a href="#" class="btn btn-danger float-left mt-3 mr-2" id="btnPrint" onclick="printDiv()">
...
<script>
    function printDiv(){
        var printContant = document.getElementById('print').innerHTML;
        var originalContant = document.body.innerHTML;
        originalContant = printContant;
        window.print();
        document.body.innerHTML = originalContant;
        location.reload();
    }
</script>
@endsection
