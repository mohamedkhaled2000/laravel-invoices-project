												...
												<td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div  class="dropdown-menu tx-13">
                                                            <a class="dropdown-item modal-effect btn text-warning btn-block" data-effect="effect-scale" data-invoice_id="{{$invoice->id}}" data-toggle="modal" href="#modaldemo7"> الغاء الارشفة</a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    ...
                                    <form action="{{ route('deleteArchive', 'test') }}" method="post">
                                        {{ method_field('POST') }}
                                        @csrf
                                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    ...
                                    <form action="{{ route('updateArchive', 'test') }}" method="post">
                                        @csrf
                                </div>
                                    <div class="modal-body">
                                        <p>هل انت متاكد من الغاء ارشفة هذه الفاتورة؟.</p>
                                        <input type="hidden" name="invoice_id" id="invoice_id" value="">
                                    </div>
                                    <div class="modal-footer">
                                        <button class="btn ripple btn-secondary" data-dismiss="modal" type="button">الغاء</button>
